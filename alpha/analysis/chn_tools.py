...
class Alpha:
    ...
    def callback_save(self) :
        ...
        tkinter.messagebox.showwarning("Save file","What are you doing, Dave?\nI can't let you do that, Dave.")
    def save_sum(self):
        ...
        fh = tkinter.filedialog.asksaveasfile(mode="w",**options)
    ...
    def callback_load(self):
        files = tkinter.filedialog.askopenfilenames(filetypes=[("Mastro Spectrum",".Chn")],
        ...
        if total_time < 300:
            ...
            tstr = "%.1f days"    
        t = self.canvas.create_text(32,32,
                                    text="Loaded %d files,\n%s of collection time" % (len(data),tstr),
                                    fill="white", anchor=tkinter.W)
        self.data = data
    def animate(self):
        step = self.step + 1
        w = self.canvas.winfo_width()
